package com.mars.wxpusher.push.xiaomi

import android.app.Activity
import android.app.AlertDialog
import android.app.Application
import com.mars.wxpusher.base.common.WxpSaveService
import com.mars.wxpusher.dialog.DialogManager
...
object XiaomiUtils {
    ...
    fun showSettingGuide(activity: Activity) {
        ...
        //在收到一次消息以后，才会有这个通知通道
        if (!WxpNotificationManager.hasNotificationChannel("mipush|com.mars.wxpusher|135072")) {
            return
        }
