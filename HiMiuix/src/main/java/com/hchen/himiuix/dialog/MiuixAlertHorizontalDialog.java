...
/**
 * Miuix Horizontal Dialog
 *
 * @author 焕晨HChen
 */
class MiuixAlertHorizontalDialog extends MiuixAlertDialogBase {
    MiuixAlertHorizontalDialog(@NonNull Dialog dialog) {
        super(dialog);
    }

    @Override
    void inflater() {
        mainLayout = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.miuix_horizontal_dialog, null);
    }
    ...
    void loadView() {
        ...
        addView(buttonsLayout, buttons = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.miuix_dialog_button_vertical_3, null));
